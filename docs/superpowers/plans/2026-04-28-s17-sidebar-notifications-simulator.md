...
- [ ] **Step 1: Create mock notification data**
...
- [ ] **Step 2: Add notification handlers to `mocks/handlers.ts`**
...
- [ ] **Step 1: Create trigger BFF route**
...
- [ ] **Step 1: Create notification query hooks**
...
- [ ] **Step 1: Add test for simulator info box**
...
- [ ] **Step 3: Add info box to simulator page**
...
- [ ] **Step 1: Add test for timing toggles**
...
- [ ] **Step 3: Implement NotificationTimingToggles**
...
- [ ] **Step 3: Implement NotificationLogTable**
...
- [ ] **Step 1: Add test for edit modal**
...
- [ ] **Step 3: Implement CompanyEditModal**
...
- [ ] **Step 1: Add test for my company page**
...
- [ ] **Step 3: Implement MyCompanyPage**
...
- [ ] **Step 1: Add test for notification settings page**
...
- [ ] **Step 3: Implement NotificationSettingsPage**
...
- [ ] **Step 3: Add deeplink to DeadlineTimeline**
...
- [ ] 사이드바: 6개 카테고리, 7개 메뉴 아이템 표시
- [ ] `/` (대시보드): 30일 타임라인에 "알림 설정 →" 링크
- [ ] `/simulator`: E-9 안내 박스 상단 표시
- [ ] `/settings/company`: 사업장 정보 + 근로자 수 + 편집 모달
- [ ] `/settings/notifications`: 수신 이메일 + 토글 + 수동 발송 + 기록 테이블
- [ ] `/companies`: 관리자 카테고리에서 접근 가능
- [ ] `/benchmark`, `/workers`, `/legal`: 기존 기능 정상 작동
