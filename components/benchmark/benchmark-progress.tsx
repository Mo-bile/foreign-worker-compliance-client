...
const STEPS = [
  ...
  { label: "AI 진단 분석 중...", icon: Brain, duration: 8000 },
  { label: "리포트 생성 중...", icon: FileCheck, duration: 2000 },
] as const;
...
export function BenchmarkProgress({ isPending }: BenchmarkProgressProps) {
  ...
  return (
    <div className="rounded-lg border bg-card p-6">
      <div className="mb-4 flex items-center gap-3">
        ...
        <div>
          <p className="text-sm font-medium">{done ? "진단 완료!" : currentStep.label}</p>
