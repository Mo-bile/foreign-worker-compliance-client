...
describe("BenchmarkEmptyState", () => {
  it("CTA 버튼을 표시한다", () => {
    render(<BenchmarkEmptyState onCreateBenchmark={() => {}} isLoading={false} />);
  ...
  it("CTA 클릭 시 콜백을 호출한다", () => {
    ...
    render(<BenchmarkEmptyState onCreateBenchmark={onCreateBenchmark} isLoading={false} />);
  ...
  it("로딩 중에는 버튼이 비활성화된다", () => {
    render(<BenchmarkEmptyState onCreateBenchmark={() => {}} isLoading={true} />);
