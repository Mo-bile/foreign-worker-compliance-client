...
describe("InsuranceBadge", () => {
  it("MANDATORY는_한글_라벨과_blue_스타일로_렌더링한다", () => {
    render(<InsuranceBadge status="MANDATORY" label="의무가입" />);
  ...
  it("AUTO_BENEFITS_OPT_IN는_indigo_스타일로_렌더링한다", () => {
    render(<InsuranceBadge status="AUTO_BENEFITS_OPT_IN" label="자동가입(급여신청형)" />);
  ...
  it("OPTIONAL_ON_APPLICATION는_gray_스타일로_렌더링한다", () => {
    render(<InsuranceBadge status="OPTIONAL_ON_APPLICATION" label="신청시가입" />);
  ...
  it("EXEMPT는_green_스타일로_렌더링한다", () => {
    render(<InsuranceBadge status="EXEMPT" label="가입제외" />);
  ...
  it("알_수_없는_status는_기본_스타일로_렌더링한다", () => {
    ...
    render(<InsuranceBadge status={"UNKNOWN" as any} label="알수없음" />);
